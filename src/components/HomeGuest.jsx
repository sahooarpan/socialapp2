    ...
    switch (action.type) {
      ...
      case "usernameAfterDelay":
        if(draft.username.value.length<3){
          draft.username.hasErrors=true
          draft.username.message="Username must be atleast 3 charecters :)"
        }
      ...
      case "emailAfterDelay":
        if(!/^\S+@\S+$/.test(draft.email.value)){
          ...
          draft.email.message="You must provide valid email"
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input id="username-register" onChange={e=>dispatch({type:"usernameImmidiately",value:e.target.value})} name="username" className="form-control" type="text" placeholder="Pick a username" autoComplete="off" />
            ...
            <div className="form-group">
              ...
              <input id="email-register"  onChange={e=>dispatch({type:"emailImmidiately",value:e.target.value})} name="email" className="form-control" type="text" placeholder="you@example.com" autoComplete="off" />
